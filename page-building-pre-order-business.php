<?php /* Template Name: Building Pre-order Business Page */ ?>
...
if (stristr($site->siteTypeGrouping, "business") !== FALSE) {
    ...
    $tpl->assignInclude("header", dirname(__FILE__) . "/templates/business/header.tpl");
}
...
$tpl->assignInclude("live-header", 	dirname ( __FILE__ ) . "/templates/business/live-header.tpl" );
