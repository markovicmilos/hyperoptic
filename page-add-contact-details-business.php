<?php /* Template Name:  Add Building Contact Details Business Page */ ?>
...
$tpl->assignInclude( "building-sidebar-menu", 	dirname ( __FILE__ ) . "/templates/business/add-contact-sidebar-menu.tpl" );
...
$tpl->newBlock('tab-building-manager');

// header-top section
$breadcrumb = new Breadcrumb();
$breadcrumb->addBreadcrumb(array("Home","Business",$site->siteName), array( esc_url( home_url( '/' )), esc_url( home_url( '/business/' )), esc_url( home_url( '/business-interest/' )) . "?siteid=" . $siteid ), $tpl);
...
$tpl->newBlock('three-tabs');
$tpl->newBlock('tab-concierge-business');
