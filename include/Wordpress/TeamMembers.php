...
class TeamCustomFields {
    ...
    if ( $output ) { ?>
        ...
        <?php
        //echo $customField[ 'description' ];
        switch ( $customField[ 'type' ] ) {
        	case "dropdown": { 
    			$options = $customField[ 'description' ];
        		echo '<label for="' . $this->prefix . $customField[ 'name' ] .'" style="display:inline;"><b>' . $customField[ 'title' ] . ':</b></label>&nbsp;&nbsp;';
        		echo '<select name="' . $this->prefix . $customField[ 'name' ] . '" id="' . $this->prefix . $customField['name'] . '" >';
        		foreach (split(",", $options) as $option){
        			$selected = ( get_post_meta( $post->ID, $this->prefix . $customField['name'], true ) == $option ) ? "selected" : "";
        ...
        ?>
        <?php if ( $customField[ 'description' ] && $customField["type"] != "dropdown" ) 
