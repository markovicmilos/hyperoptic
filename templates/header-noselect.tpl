...
<body class="{header-body-class}">
    ...
    <script type="text/javascript">
        var _adftrack = {
            ...
            order: {
                ...
                sales: '{track-order-amount}',
                sv14: '{track-promo-code}',
                sv19: '{track-contract-length}',
                itms: [{
                    sv8: '{track-city}',
                    sv9: '{track-postcode}',
                    sv12: '{track-product-type}',
                    sv13: '{track-package-name}'
                }]
            }
        };
        (function(){var s=document.createElement('script');s.type='text/javascript';s.async=true;s.src='https://track.adform.net/serving/scripts/trackpoint/async/';var x = document.getElementsByTagName('script')[0];x.parentNode.insertBefore(s, x);})();
    ...
    <noscript>
        <img src="https://www.awin1.com/sread.img?tt=ns&amp;tv=2&amp;merchant=5737&amp;amount={track-order-amount2}&amp;ref={track-order-id2}&amp;parts=COMMISSION_GROUP:SALE_AMOUNT&amp;vc={track-promo-code2}&ch=aw&amp;testmode=0&cr=GBP" />
    </noscript>
    <!-- END BLOCK : tracking-op-complete -->
			...
			<nav class="navbar navbar-default" role="navigation">
				<div>
					...
					<div class="collapse navbar-collapse"id="bs-example-navbar-collapse-1" style="overflow-x: hidden;">
                        ...
                        <a href="{home-url}business"><p class="pad-right-fixed-15 font-f-bariol-regular font-21 gray-f-4 header-rbp-links header-rbp-links-l-768" >Business</p></a>
                        <a href="{home-url}property"><p class="pad-right-fixed-15 font-f-bariol-regular font-21 gray-f-4 header-rbp-links header-rbp-links-l-768" >Property</p></a>
