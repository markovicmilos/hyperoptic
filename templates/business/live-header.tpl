<div class=" progress-h-active col-xs-12 col-sm-12 col-md-6 gray-bg-3">
	...
	<p class=" marg-top-fixed-15 font-18  blue-navy-f-2" > We’re accepting pre-orders for {menu-title}</p>
...
<div class="  col-xs-12 col-sm-12 col-md-6 pad-left-percent-0  pad-top-fixed-10 pad-bottom-fixed-10 gray-bg-3" id="menu-container" >
    <form id="postcodeForm" onsubmit="return onGoClickedLive();">
        <div class="col-xs-3 col-sm-3 col-md-4 col-lg-4 pad-right-percent-0">
            <p class="marg-top-fixed-10 font-12 gray-f-1 pull-left"> START YOUR PRE-ORDER</p>
        </div>
        <div class=" col-xs-6 col-sm-6 col-md-5 col-lg-5 pad-left-percent-1">
        ...
        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 pad-all-0">
            <button type="submit" id="register-ue" class="btn btn-primary pre-order-button btn-l-768 let-space-minus-05 pull-right">PRE-ORDER NOW</button>
        </div>
