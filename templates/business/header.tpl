...
<head>
    ...
    <script src="{base-url}/js/global.js?v=2"></script>
	<script>
	...
	<script type="text/javascript">
		...
		<noscript>
			<p style="margin:0;padding:0;border:0;">
				<img src="https://track.adform.net/Serving/TrackPoint/?pm=189202&amp;lid=4830051" width="1" height="1" alt="" />
			</p>
		</noscript>
			...
			<nav class="navbar navbar-default" role="navigation">
				<div>
					...
					<div class="collapse navbar-collapse"id="bs-example-navbar-collapse-1" style="overflow-x: hidden;">
                        ...
                        <a href="{home-url}business"><p class="marg-top-fixed-m5 pad-right-fixed-15 font-f-bariol-regular font-21 gray-f-4 header-rbp-links header-rbp-links-l-768" >Business</p></a>
