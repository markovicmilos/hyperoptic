<!-- Modal Please read -->
<div class="modal fade" id="pleaseReadModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	<div class="modal-content gray-bg-1">
	  ...
	  <!-- /.modal-body -->
	  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pad-all-0 gray-bg-1" ><!-- Report problem form -->
		 <p class="pad-top-fixed-15 marg-left-fixed-20 font-13 black-f-1 font-w-600"> Important points you should know before you sign up to Hyperoptic's Telephone Service   </p>
		 <p class="marg-left-fixed-20 font-15 gray-f-2 pad-right-fixed-15"> 
...
The address information I provide will take a minimum of 2 working days to be available to the 999/112 emergency call centre operators. That means if I need to dial 999 or 112 from my Hyperoptic line in the meantime, I will need to tell the operator my address.
		 ...
		 <p class="marg-left-fixed-20 font-15 gray-f-2 pad-right-fixed-15 pad-bottom-fixed-10"> 
By clicking "I Accept" you confirm that you have read and understand how Hyperoptic's Telephone Service connects you to the Emergency Services, how that connection may fail and how our 999/112 Dialling works.
	  ...
	  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pad-bottom-fixed-20 pad-left-fixed-20 gray-bg-1">
		<div class="checkbox checkbox-success pad-top-fixed-15 font-13 gray-f-1 b-t-1px-gray">
			<input id="cbIReadAndAgree" name="cbiReadAndAgree" type="checkbox" >
			<label for="cbIReadAndAgree">
			   I have read and agree to the telephone Terms and Conditions
			</label>
			<button id="bntIReadAndAgree" type="submit" class="btn btn-primary " style="float:right" disabled="disabled">SUBMIT</button>
		</div>
	  </div>
	  </form>
	</div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal Entire Modal Please read -->