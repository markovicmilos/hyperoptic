			...
			<nav class="navbar navbar-default" role="navigation">
				<div>
					...
					<div class="collapse navbar-collapse"
                        ...
                        <a href="{home-url}property"><p class="marg-top-fixed-m5 pad-right-fixed-15 font-f-bariol-regular font-21 font-w-600 black-f-1 header-rbp-links header-rbp-links-l-768" >Property</p></a>
