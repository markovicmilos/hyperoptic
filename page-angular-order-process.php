<?php /* Template Name: Angular Order Process Page */ ?>
...
$tpl = new TemplatePower ( dirname ( __FILE__ ) . "/templates/order/order-page.tpl" );
...
$tpl->assign( 'siteId',                         $_REQUEST["siteid"]);
$tpl->assign( 'csfId',                          $_SESSION["CSF"]);
$tpl->newBlock('Residential-templates');
$tpl->newBlock('Residential-header');
