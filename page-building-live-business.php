<?php /* Template Name: Building Live Business Page */ ?>
...
$tpl->assignInclude("site-live", dirname(__FILE__) . "/templates/business/building-live.tpl");
$tpl->assignInclude("live-header", dirname(__FILE__) . "/templates/business/business-live-header.tpl");
...
$tpl->newBlock('contract-12-1');
$tpl->newBlock('contract-12-2');
$tpl->newBlock('contract-12-3');
