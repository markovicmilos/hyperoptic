/**
 * Created by Marko Vasic on 6/3/15.
 */
...
// This can be downloaded locally also
(function(d, s, id) {
...
// function used to fill the data
...
function fillData() {
    ...
    FB.api('/me', function(response) {
        ...
        document.getElementById('fb-button-holder').style.display = "none";
    });
}