<?php /* Template Name: Business Package Page */ ?>
...
$tpl = new TemplatePower ( dirname ( __FILE__ ) . "/templates/business-package.tpl" );
...
$tpl->assign( "header-title", 			"Hyperoptic | Residential Fibre Optic Broadband | Business Package ");
