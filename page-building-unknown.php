<?php /* Template Name: Building Unknown Page */ ?>
...
$tpl = new TemplatePower ( dirname ( __FILE__ ) . "/templates/building-unknown.tpl" );
...
$tpl->assign( "header-jscript", 		'<script src="https://maps.googleapis.com/maps/api/js"></script>
										 ...
										 <script>
											...
											$( document ).ready(function() {
												$("#registerInterestForm").validate({ignore: "", rules: {	email: "validEmail" } });	'.
